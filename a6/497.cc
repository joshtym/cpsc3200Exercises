/*
 * Solution to exercise 497 on UVA. Uses the longest ascending subsequence class
 * from Howard Cheng. The logic behind it is that it determines what the 
 * longest strictly ascending subsequence to determine how many missles we can shoot down
 *
...
int main(int argc, char** argv)
{
   ...
   for (int i = 0; i < testCases; ++i)
   {
      ...
      {
         /*
          * I wanted to mess with string streams this time, so I used string streams for input
         */
      ...
      /*
       * Create arrays that we can properly use in the provided class from
       * Howard. Then, get our number hit and do the thing Zhu Li!
      */
